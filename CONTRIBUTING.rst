...
regarding development in xreshaper for maintainers and contributors.
...
Report bugs for xreshaper in the `issue tracker <https://github.com/NCAR/xreshaper>`_.

If you are reporting a bug, please include:

* Your operating system name and version.
* Any details about your local setup that might be helpful in troubleshooting,
  specifically the Python interpreter version, installed libraries, and xreshaper
  version.
...
#. Fork the
   `xreshaper GitHub repository <https://github.com/NCAR/xreshaper>`__.  It's
